...
CREATE TABLE IF NOT EXISTS exchange_rates (
  ...
  provider_rate_type ENUM('manual', 'mid', 'customer_sell', 'customer_buy') NOT NULL DEFAULT 'manual',
  ...
  KEY idx_exchange_rates_reference_lookup (source, workspace_id, from_currency_id, to_currency_id, provider_rate_type, rate_date, created_at, id),
  KEY idx_exchange_rates_account_manual_lookup (source, workspace_id, user_id, from_currency_id, to_currency_id, rate_date, created_at, id),
  KEY idx_exchange_rates_reference_fetched (source, workspace_id, fetched_at),
...
CREATE TABLE IF NOT EXISTS budgets (
  ...
  participant_mode ENUM('solo', 'group') NOT NULL DEFAULT 'solo',
  installment_display_mode ENUM('item', 'overall') NOT NULL DEFAULT 'item',
  installment_period_unit ENUM('day', 'week', 'month', 'year') NOT NULL DEFAULT 'month',
  pricing_enabled TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS budget_items (
  ...
  KEY idx_budget_items_budget_sort (budget_id, sort_order, id),
  KEY idx_budget_items_budget_category (budget_id, category_id),
...
CREATE TABLE IF NOT EXISTS budget_participants (
  ...
  KEY idx_budget_participants_budget_sort (budget_id, sort_order, id),
...
CREATE TABLE IF NOT EXISTS budget_transactions (
  ...
  KEY idx_budget_transactions_budget_category_sort (budget_id, category_id, sort_order, id),
  KEY idx_budget_transactions_budget_sort (budget_id, sort_order, id),
...
CREATE TABLE IF NOT EXISTS budget_bookkeeping_records (
  ...
  KEY idx_budget_bookkeeping_records_budget_type_date (budget_id, transaction_type, record_date, sort_order, id),
  KEY idx_budget_bookkeeping_records_budget_sort (budget_id, sort_order, id),
...
CREATE TABLE IF NOT EXISTS budget_exports (
  ...
  scope VARCHAR(40) NOT NULL DEFAULT 'budget',
  file_name VARCHAR(255) NOT NULL,
  file_path VARCHAR(500) NULL,
  status ENUM('queued', 'processing', 'completed', 'failed') NOT NULL DEFAULT 'queued',
  job_token CHAR(64) NULL,
  options_json JSON NULL,
  error_message TEXT NULL,
  progress_percent DECIMAL(5,2) NOT NULL DEFAULT 0,
  progress_stage VARCHAR(80) NOT NULL DEFAULT 'queued',
  rows_total BIGINT UNSIGNED NULL,
  ...
  KEY idx_budget_exports_budget_format_created (budget_id, format, created_at, id),
  KEY idx_budget_exports_status_lock (status, locked_until, created_at, id),
  KEY idx_budget_exports_status_id (status, id),
...
CREATE TABLE IF NOT EXISTS audit_logs (
  ...
  KEY idx_audit_logs_workspace_created (workspace_id, created_at, id),

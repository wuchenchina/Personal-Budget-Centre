...
export const ruApiErrorMessages = {
  ...
  EXCHANGE_RATE_NOT_FOUND: "Курс обмена отсутствует. Введите курс вручную; при необходимости используйте Mastercard как справочник: https://www.mastercard.com/am/en/personal/get-support/currency-exchange-rate-converter.html",

...
export const ruDictionary = {
  ...
  primaryCurrencyHelp: 'Используется как настройка аккаунта и подсказка для новых данных. Не перезаписывает существующие рабочие пространства или курсы бюджета.',
  delete: 'Удалить',
  ...
  cleanup: 'Очистить',
  cleanupExports: 'Очистить PDF-экспорты',
  confirmCleanupExports: 'Удалить созданные PDF, записи экспорта и временные файлы? PDF будут созданы заново при следующем экспорте.',
  ...
  passwordResetChecking: 'Проверка ссылки сброса...',
  passwordResetEmailAction: 'Отправить ссылку сброса',
  passwordResetEmailSent: 'Если для этой учетной записи доступен сброс, письмо уже отправлено.',
  ...
  passwordResetSuccessMessage: 'Теперь можно войти с новым паролем.',
  passwordResetTitle: 'Сброс пароля',
  passwordResetTokenInvalid: 'Ссылка сброса пароля недействительна или истекла.',
  passwordResetWithPasskey: 'Подтвердить passkey',
  passwordResetWithSso: 'Подтвердить через {provider}',
  pdfExportApplySettings: 'Применить настройки',
  pdfExportLanguages: 'Языки PDF',
  pdfExportLanguagesDescription: 'Выбранные языки объединяются в одном PDF-документе. Упрощенный и традиционный китайский взаимоисключают друг друга.',
  ...
  pdfExportSignatureLabelLanguagesDescription: 'Выберите языки, отображаемые в поле подписи PDF. Упрощенный и традиционный китайский следуют одному взаимоисключающему выбору.',
  ...
  pdfThemeStatementRed: 'Стиль Formal Statement',
  pdfThemeStatementRedDescription: 'Макет в стиле официальных документов для экспорта бюджета и учета.',
  pdfThemeCivicBlue: 'Civic Blue',
  pdfThemeCivicBlueDescription: 'Макет в стиле синего публичного оформления для государственного сектора с четкой синей иерархией и читаемыми таблицами.',
  ...
  rate: 'Курс',
  rateSaveScope: 'Область курса',
  rateScopeBudget: 'Сохранить для бюджета',
  rateScopeItem: 'Только эта строка',
  rates: 'Курсы',
  refresh: 'Обновить',
  request: 'Запрос',
  ...
  syncGlobalRateToBudget: 'Применить глобальный курс к бюджету',
...
export const ruApiErrorMessages = {
  ...
  EXCHANGE_RATE_NOT_FOUND: "Курс обмена отсутствует. Введите курс вручную или используйте внешний справочник.",
  EXCHANGE_RATE_PROVIDER_DISABLED: "Этот поставщик курсов отключен. Используйте bank reference или ручные курсы.",
  ...
  EXPORT_FAILED: "Не удалось создать файл экспорта. Проверьте PDF renderer, шрифты и права каталога экспорта.",
  ...
  PASSWORD_RESET_NOT_AVAILABLE: "Сброс пароля недоступен для этой учетной записи.",
  PASSWORD_RESET_TOKEN_INVALID: "Ссылка сброса пароля недействительна или истекла.",

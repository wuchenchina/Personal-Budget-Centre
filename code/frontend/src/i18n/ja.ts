...
export const jaDictionary = {
  ...
  cleanup: 'クリーンアップ',
  cleanupExportCache: 'PDF エクスポートをクリーンアップ',
  confirmCleanupExportCache: '生成済み PDF、エクスポート記録、一時ファイルを削除しますか？次回エクスポート時に再生成されます。',
  ...
  pdfThemeUswdsDescription: 'USWDS 風の公共部門向けレイアウトで、明確な青い階層と読みやすい表を使用します。',
...
export const jaApiErrorMessages = {
  ...
  EXCHANGE_RATE_NOT_FOUND: "為替レートが不足しています。手動レートを入力してください。必要に応じて Mastercard を参照できます: https://www.mastercard.com/am/en/personal/get-support/currency-exchange-rate-converter.html",
  ...
  EXPORT_FAILED: "エクスポートファイルの作成に失敗しました。Chromium、フォント、出力先権限を確認してください。",

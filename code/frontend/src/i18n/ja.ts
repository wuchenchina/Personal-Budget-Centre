...
export const jaDictionary = {
  ...
  passwordResetChecking: 'リセットリンクを確認中...',
  passwordResetEmailAction: 'リセットリンクを送信',
  passwordResetEmailSent: 'このアカウントでリセット可能な場合、リセットメールを送信しました。',
  passwordResetFailed: 'パスワードのリセットに失敗しました',
  passwordResetReadyFor: '{email} のパスワードをリセットします。',
  passwordResetSubmit: 'パスワードをリセット',
  passwordResetSuccess: 'パスワードをリセットしました',
  passwordResetSuccessMessage: '新しいパスワードでサインインできます。',
  passwordResetTitle: 'パスワードをリセット',
  passwordResetTokenInvalid: 'パスワードリセットリンクが無効または期限切れです。',
  passwordResetWithPasskey: 'パスキーで確認',
  passwordResetWithSso: '{provider} で確認',
...
export const jaApiErrorMessages = {
  ...
  PASSWORD_RESET_NOT_AVAILABLE: "このアカウントではパスワードリセットを利用できません。",
  PASSWORD_RESET_TOKEN_INVALID: "パスワードリセットリンクが無効、または期限切れです。",

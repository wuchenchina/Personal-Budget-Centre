...
export const frApiErrorMessages = {
  ...
  EXCHANGE_RATE_NOT_FOUND: "Le taux de change est manquant. Saisissez un taux manuel ; vous pouvez consulter Mastercard : https://www.mastercard.com/am/en/personal/get-support/currency-exchange-rate-converter.html",

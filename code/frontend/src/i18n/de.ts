...
export const deDictionary = {
  ...
  primaryCurrency: 'Primaere Waehrung',
  primaryCurrencyHelp: 'Wird als Kontopraeferenz und Vorschlag fuer neue Daten genutzt. Bestehende Arbeitsbereiche oder Budgetkurse werden nicht ueberschrieben.',
  delete: 'Loeschen',
  ...
  cleanup: 'Bereinigen',
  cleanupExports: 'PDF-Exporte bereinigen',
  confirmCleanupExports: 'Generierte PDFs, Exportdatensaetze und temporaere Dateien loeschen? PDFs werden beim naechsten Export neu erzeugt.',
  ...
  passwordResetChecking: 'Reset-Link wird geprueft...',
  passwordResetEmailAction: 'Reset-Link senden',
  passwordResetEmailSent: 'Falls dieses Konto das Passwort zuruecksetzen kann, wurde eine E-Mail gesendet.',
  passwordResetFailed: 'Passwort konnte nicht zurueckgesetzt werden',
  passwordResetReadyFor: 'Passwort fuer {email} zuruecksetzen.',
  passwordResetSubmit: 'Passwort zuruecksetzen',
  passwordResetSuccess: 'Passwort zurueckgesetzt',
  passwordResetSuccessMessage: 'Sie koennen sich jetzt mit dem neuen Passwort anmelden.',
  passwordResetTitle: 'Passwort zuruecksetzen',
  passwordResetTokenInvalid: 'Der Passwort-Reset-Link ist ungueltig oder abgelaufen.',
  passwordResetWithPasskey: 'Mit Passkey bestaetigen',
  passwordResetWithSso: 'Mit {provider} bestaetigen',
  pdfExportApplySettings: 'Einstellungen anwenden',
  pdfExportLanguages: 'PDF-Sprachen',
  pdfExportLanguagesDescription: 'Ausgewaehlte Sprachen werden im selben PDF-Dokument kombiniert. Vereinfachtes und traditionelles Chinesisch schliessen sich aus.',
  ...
  pdfExportSignatureLabelLanguagesDescription: 'Waehlen Sie die Sprachen, die im PDF-Signaturfeld angezeigt werden. Vereinfachtes und traditionelles Chinesisch folgen derselben Auswahl.',
  ...
  pdfThemeStatementRed: 'Formal Statement-Stil',
  pdfThemeStatementRedDescription: 'An offiziellen Belegen orientiertes Layout fuer Budget- und Buchhaltungsexporte.',
  pdfThemeCivicBlue: 'Civic Blue',
  pdfThemeCivicBlueDescription: 'Nutzt ein an blaues dokumentorientiertes Layout für den öffentlichen Sektor mit klarer blauer Hierarchie und gut lesbaren Tabellen.',
  ...
  rate: 'Kurs',
  rateSaveScope: 'Kurs-Speicherbereich',
  rateScopeBudget: 'Fuer dieses Budget speichern',
  rateScopeItem: 'Nur dieser Eintrag',
  rates: 'Kurse',
  ...
  syncGlobalRateToBudget: 'Globalen Kurs auf dieses Budget anwenden',
...
export const deApiErrorMessages = {
  ...
  EXCHANGE_RATE_NOT_FOUND: "Der Wechselkurs fehlt. Geben Sie einen manuellen Kurs ein oder verwenden Sie eine externe Referenz.",
  EXCHANGE_RATE_PROVIDER_DISABLED: "Dieser Wechselkursanbieter ist deaktiviert. Verwenden Sie bank reference oder manuelle Kurse.",
  ...
  EXPORT_FAILED: "Exportdatei konnte nicht erstellt werden. Prüfen Sie PDF-Renderer, Schriftarten und Berechtigungen des Exportverzeichnisses.",
  ...
  PASSWORD_RESET_NOT_AVAILABLE: "Passwort-Zuruecksetzen ist fuer dieses Konto nicht verfuegbar.",
  PASSWORD_RESET_TOKEN_INVALID: "Der Passwort-Reset-Link ist ungueltig oder abgelaufen.",

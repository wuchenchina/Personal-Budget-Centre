...
const classicSectionBandTitleFontSizePt = 9
...
func classicPDFTheme() Definition {
	return staticTheme{
		...
		sectionBandTitlePt:     classicSectionBandTitleFontSizePt,
